...
## &#9997;Lektion 12 | haben und sein | verb conjugation
#### summary
...
## &#9997;Lektion 14 | Regelmäßige Verben | Regular Verbs in German

> 学习目标：规则动词现在时态的动词变位规则

#### summary
1. 常规情况

	<table> <thead> <tr> <th></th> <th>单数</th> <th>复数</th> </tr> </thead> <tbody> <tr> <td>第一人称</td> <td>ich + 词干 + e</td> <td>wir + 词干 + en</td> </tr> <tr> <td>第二人称</td> <td>du + 词干 + st</td> <td>ihr + 词干 + t</td> </tr> <tr> <td>第二人称</td> <td>Sie + 词干 + en</td> <td>Sie + 词干 + en</td> </tr> <tr> <td>第三人称</td> <td>er/sie/es + 词干 + t</td> <td>sie + 词干 + en</td> </tr> </tbody> </table>

2. 特殊情况

	2.1 词干以"**-s, -ß, -z**"结尾，词尾的"**-st** "变为"**-t**"。 
   
	2.2 词干以"**-d, -t**"结尾，词尾的"**-st**"改为"**-est**"，"**-t**"改为"**-et**"。


## &#9997;Lektion 15 | Unregelmäßige Verben | Irregular Verbs in German
> 学习目标：不规则动词变形基本规则

#### summary
- 词尾变形与规则动词一致。
- 元音变化（主要出现在du、er/sie/es中）
	- **e &#10145; i**
		
		- nehmen(to take)，essen(to eat)，treffen(to meet)，helfen(to help)，geben(to give)
	- **e&#10145;ie**
	...
	- **a&#10145;ä**
		...
		- fahren(to drive)，schlafen(to sleep)，waschen(to wash)
	- **i&#10145;ei** 
		
		- &#11088; wissen(to know)  
		
		  <table> <thead> <tr> <th>单数</th> <th>复数</th> </tr> </thead> <tbody> <tr>  <td>ich：w<u>ei</u>ß </td> <td>wir：wissen</td> </tr> <tr> <td>du：w<u>ei</u>ßt</td> <td>ihr：wisst</td> </tr> <tr> <td>Sie：wissen</td> <td>Sie：wissen</td> </tr> <tr> <td>er/sie/es：w<u>ei</u>ß </td> <td>sie：wissen</td> </tr> </tbody> </table>

## &#9997;Lektion 16 | Numbers above 100 in German | Zahlen Teil 3
> 学习目标：100以上的数字读写以及年份读写
...
<table>
      ...
      <tbody>
        ...
        <tr>
          <th>2.000.000</th>
            <td>zwei Million<u>en</u></td>
          <td>需使用复数</td>
        </tr>
        <tr>
          <th>100.000.000</th>
          <td>(ein)hundert Millionen</td>
          <td></td>
        </tr>
        <tr>
          <th>1.000.000.000</th>
          <td>eine Milliarde：one billion</td>
          <td></td>
        </tr>
        <tr>
          <th>2.000.000.000</th>
            <td>zwei Milliard<u>en</u></td>
          <td></td>
        </tr>
      </tbody>
    </table>
...
**读写**：先最大数，到十位数时先读写个位再读写十位，中间没有空格。

- 121：(ein)hunderteinundzwanzig
- 1101：(ein)tausandeinhunderteins

**年份**：一般是两位两位的读。

- <u>19</u> <u>75</u>：neunzehnhundertfünfundsiebzig
- <u>2</u>0 <u>17</u>：zweitausendsiebzehn
- 例句：
  - Wann bist du geboren? (when were you born?)
  - Ich bin (im Jahr) 1990 (neunzehnhundertneunzig) geboren.


## &#9997;Lektion 17 | Adjectives and Opposites | Adjektive und Gegenteile
> 学习目标：部分形容词和对应的反义词
> 注意：学习形容词最好和反义词一起学习，方便记忆。
...
## &#9997;Lektion 18 | Introducing someone in German | jemanden vorstellen
